...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="mindex.cdb"><span class="main_tabs_span" style="font-size: 50px; font-weight: bold; color: #ffffff;">ChimerDB</span></a>
    </div>
